  ...
  html += `<div class="overflow-x-auto"><table class="w-full text-xs">
    <thead class="text-zinc-500 uppercase">
      <tr>
        ...
        <th class="text-right px-2 py-1 cursor-pointer select-none hover:text-white hidden xl:table-cell" onclick="handleSort('${scanId}', 'world_sold_72h')">Seraph sales ${sortArrow('world_sold_72h', state)}</th>
